...
///////////////////
Улучшение по типу 5
// Время ожидания перед атакой 
// важно, чтобы 
// игрок не мог 
// атаковать слишком часто 
// и получить 
// нечестное преимущество.
// Мы проверяем, прошло ли 
...
///////////////////
Улучшение по типу 6
// TODO: Реализовать систему "агрессивности" врагов. 
// В зависимости от уровня "агрессивности", враги 
// будут атаковать игрока с разной 
// частотой и дальностью.
void UpdateEnemyBehavior(Enemy enemy)
{
    // Текущая логика поведения врага
}
